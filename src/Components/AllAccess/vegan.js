    ...
    return (
      <div className="nibble-main">
        ...
        <div className="meal-title-image">
          <img src="../../images/lonely.png" alt="Lonely Vegan"/>
          </div>
                   <div className="meal-title">The Lonely Vegan</div>
          <div className="meal-text">
          We created this video to help those of you who are the only plant-based eaters in your home or circle of friends/family.  This free video gives you tips about how to foster healthy relationships while changing your eating habits.
            <br />
          </div>
