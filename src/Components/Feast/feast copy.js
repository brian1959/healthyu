...
export default class Feast2 extends Component {
  render() {
          ...
          <div className="inst-vids-wrapper">
            <div className="week-wrapper">
              ...
              <iframe
                  width="100%"
                  title="Oats"
                  href="https://drive.google.com/file/d/13Rj3M6HAU8fApMIglo9X45BPPSIenc44/preview" allow="fullscreen"
                />
                <h2>Oats</h2>
              </div>
              <div className="inst-vids">
